...
/**
 * Class ActiveRecord
 * ActiveRecord pattern has been implemented.
 *
...
abstract class ActiveRecord
{
    ...
    /**
     * Find records for specified search condition in database table
     *
     * @param string $mode The search condition
     * @param mixed|null $value The database table field value
     *
